  ...
  <div class="bg-white">
    ...
    <main class="isolate">
      ...
      <div class="overflow-hidden relative isolate -z-10 bg-blue-100 py-32 pb-24 md:pt-40">
          <NolusContainer>
            <div class="hidden md:block md:absolute -top-12 scale-75 lg:scale-100 md:-right-96 lg:-right-64 xl:-right-16">
              <canvas id="myCanvas" ref="myCanvas" style="clip-path: polygon(50% 0%,50% 0%,47.041% 0.088%,44.103% 0.349%,41.193% 0.782%,38.318% 1.384%,35.486% 2.153%,32.703% 3.087%,29.979% 4.183%,27.318% 5.44%,24.73% 6.855%,22.221% 8.426%,22.221% 8.426%,19.81% 10.143%,17.512% 11.993%,15.333% 13.969%,13.277% 16.067%,11.349% 18.28%,9.555% 20.603%,7.899% 23.028%,6.385% 25.551%,5.019% 28.166%,3.806% 30.866%,3.806% 30.866%,2.755% 33.633%,1.872% 36.447%,1.158% 39.302%,0.614% 42.188%,0.241% 45.099%,0.039% 48.027%,0.009% 50.964%,0.153% 53.903%,0.469% 56.835%,0.961% 59.755%,0.961% 59.755%,1.624% 62.639%,2.453% 65.47%,3.446% 68.24%,4.597% 70.942%,5.904% 73.57%,7.363% 76.116%,8.97% 78.575%,10.721% 80.939%,12.614% 83.201%,14.645% 85.355%,14.645% 85.355%,16.799% 87.386%,19.061% 89.279%,21.425% 91.03%,23.884% 92.637%,26.43% 94.096%,29.058% 95.403%,31.76% 96.554%,34.53% 97.547%,37.361% 98.376%,40.245% 99.039%,40.245% 99.039%,43.165% 99.531%,46.097% 99.847%,49.036% 99.991%,51.973% 99.961%,54.901% 99.759%,57.812% 99.386%,60.698% 98.842%,63.553% 98.128%,66.367% 97.245%,69.134% 96.194%,69.134% 96.194%,71.834% 94.981%,74.449% 93.615%,76.972% 92.101%,79.397% 90.445%,81.72% 88.65%,83.933% 86.723%,86.03% 84.667%,88.007% 82.488%,89.857% 80.19%,91.573% 77.778%,91.573% 77.778%,93.144% 75.27%,94.56% 72.681%,95.816% 70.021%,96.913% 67.296%,97.847% 64.514%,98.616% 61.682%,99.218% 58.807%,99.651% 55.897%,99.912% 52.959%,100% 50%,100% 50%,99.843% 46.041%,99.377% 42.131%,98.609% 38.287%,97.546% 34.527%,96.194% 30.866%,94.561% 27.321%,92.654% 23.91%,90.479% 20.649%,88.044% 17.555%,85.355% 14.645%,85.355% 14.645%,82.445% 11.956%,79.351% 9.521%,76.09% 7.346%,72.679% 5.439%,69.134% 3.806%,65.473% 2.454%,61.712% 1.391%,57.869% 0.623%,53.959% 0.157%,50% 0%,67.482% 74.997%,32.521% 74.997%,32.521% 74.997%,31.926% 74.973%,31.338% 74.903%,30.76% 74.788%,30.195% 74.628%,29.644% 74.425%,29.111% 74.179%,28.598% 73.892%,28.108% 73.565%,27.643% 73.199%,27.205% 72.795%,27.205% 72.795%,26.801% 72.357%,26.435% 71.892%,26.108% 71.402%,25.821% 70.889%,25.576% 70.356%,25.372% 69.806%,25.212% 69.24%,25.097% 68.662%,25.027% 68.074%,25.003% 67.479%,25.003% 32.518%,25.003% 32.518%,25.027% 31.922%,25.097% 31.335%,25.212% 30.757%,25.372% 30.191%,25.576% 29.641%,25.821% 29.108%,26.108% 28.595%,26.435% 28.105%,26.801% 27.639%,27.205% 27.202%,27.205% 27.202%,27.643% 26.798%,28.108% 26.431%,28.598% 26.104%,29.111% 25.818%,29.644% 25.572%,30.195% 25.369%,30.76% 25.209%,31.338% 25.094%,31.926% 25.024%,32.521% 25%,67.482% 25%,67.482% 25%,68.078% 25.024%,68.665% 25.094%,69.243% 25.209%,69.809% 25.369%,70.359% 25.572%,70.892% 25.818%,71.405% 26.104%,71.895% 26.431%,72.36% 26.798%,72.798% 27.202%,72.798% 27.202%,73.202% 27.639%,73.568% 28.105%,73.895% 28.595%,74.182% 29.108%,74.428% 29.641%,74.631% 30.191%,74.791% 30.757%,74.907% 31.335%,74.977% 31.922%,75% 32.518%,75% 67.479%,75% 67.479%,74.977% 68.074%,74.907% 68.662%,74.791% 69.24%,74.631% 69.806%,74.428% 70.356%,74.182% 70.889%,73.895% 71.402%,73.568% 71.892%,73.202% 72.357%,72.798% 72.795%,72.798% 72.795%,72.36% 73.199%,71.895% 73.565%,71.405% 73.892%,70.892% 74.179%,70.359% 74.425%,69.809% 74.628%,69.243% 74.788%,68.665% 74.903%,68.078% 74.973%,67.482% 74.997% )" v-motion :initial="{ opacity: 0 }" :enter="{ opacity: 1}" :delay="300"></canvas>
            </div>
            <div class="max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
              <div class="w-full max-w-xl lg:shrink-0 xl:max-w-3xl">
                ...
                <p class="basis-1/2 relative mt-6 text-lg leading-8 text-neutral-800 sm:max-w-md lg:max-w-lg" v-motion :initial="{ opacity: 0, y: 10 }" :enter="{ opacity: 1, y: 0, scale: 1 }" :delay="200">Members actively participate in protocol governance by delegating and voting on proposals, which range from fine-tuning parameters to implementing protocol enhancements. This dynamic process unfolds within a Proof-of-Stake blockchain framework, where the community plays a pivotal role in driving decentralization, ensuring consensus, and enhancing security</p>
          ...
          <div class="md:mt-0 mt-8">
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <ProposalItem
                  ...
                  v-motion :initial="{ opacity: 0, y: -100 }" :enter="{ opacity: 1, y: 0, scale: 1, transition: {duration: 400} }" :leave="{ opacity: 0, y: 100 }"
                />
              </div>
