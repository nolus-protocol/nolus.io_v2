      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8 lg:gap-x-12 lg:gap-y-12 items-start">
        <div class="bg-white overflow-hidden rounded-2xl shadow-xl">
          <div class="p-6 md:p-12">
            ...
            <p class="mt-3 lg:mt-6 text-base lg:text-lg leading-8 text-neutral-600">Nolus taps into a diverse set of liquidity hubs, enabling immediate lending or asset swapping without creating fragmentation across markets</p>
          </div>
          <div>
