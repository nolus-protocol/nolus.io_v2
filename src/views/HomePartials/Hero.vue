<template>
  <div class="relative isolate overflow-hidden bg-neutral-100" ref="heroWrapper">
    <div class="relative mx-auto max-w-7xl px-6 py-32 pb-24 lg:px-8 lg:pt-28">
      ...
      <div class="w-full my-12 absolute md:scale-100 left-0 md:left-auto -right-48 sm:-right-56 lg:-right-72 top-20 md:top-10 -z-10 mx-auto lg:mt-0" aria-hidden="true">
        <video ref="videoRef" @loadeddata="isVideoLoaded = true" class="h-[1px] w-[1px]" muted autoplay playsinline data-timing="7" data-wait="240" loop :poster='videoPoster'>
...
const stats = [
  { id: 1, subtitle: 'Tx Volume', description: 'Transactional value channeled through Nolus', value: '$100,000,000' },
