          ...
          <NolusContainer class="flex items-center">
            <div class="md:max-w-[50%] lg:max-w-2xl gap-x-14 lg:flex lg:max-w-none lg:items-center">
              <div class="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                <h1 class="text-3xl md:text-3xl lg:text-5xl font-bold tracking-tight text-white leading-tight" v-motion :initial="{ opacity: 0, y: 10 }" :enter="{ opacity: 1, y: 0, scale: 1 }" :delay="100">Reshaping<br>Money Markets</h1>
