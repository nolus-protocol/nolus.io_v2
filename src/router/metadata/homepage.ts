export const META = {
  title: "Next-Gen Margin Trading with Asset-Backed Leverage",
  ...
  "og:title": "Next-Gen Margin Trading with Asset-Backed Leverage",
  ...
  "twitter:title": "Next-Gen Margin Trading with Asset-Backed Leverage",
